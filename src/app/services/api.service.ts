...
export class ApiService {
  ...
  createTester(testerData: FormData): Observable<Tester> {
    return this.http
      .post<Tester>(`${this.baseUrl}/testers`, testerData)
      .pipe(catchError(this.handleError));
  }
  ...
  createProject(projectData: any): Observable<Project> {
    return this.http
      .post<Project>(`${this.baseUrl}/projects`, projectData)
      .pipe(catchError(this.handleError));
  }

  updateProject(id: number, projectData: any): Observable<Project> {
    return this.http
      .put<Project>(`${this.baseUrl}/projects/${id}`, projectData)
      .pipe(catchError(this.handleError));
  }
  ...
  getTestCases(): Observable<TestCase[]> {
    return this.http
      .get<TestCase[]>(`${this.baseUrl}/test-cases`)
      .pipe(catchError(this.handleError));
  }

  createTestCase(testCaseData: any): Observable<TestCase> {
    return this.http
      .post<TestCase>(`${this.baseUrl}/test-cases`, testCaseData)
      .pipe(catchError(this.handleError));
  }

  updateTestCase(id: number, testCaseData: any): Observable<TestCase> {
    return this.http
      .put<TestCase>(`${this.baseUrl}/test-cases/${id}`, testCaseData)
      .pipe(catchError(this.handleError));
  }

  deleteTestCase(id: number): Observable<void> {
    return this.http
      .delete<void>(`${this.baseUrl}/test-cases/${id}`)
      .pipe(catchError(this.handleError));
  }
  ...
  getProjectStats(projectId: number): Observable<any> {
    return this.http
      .get<any>(`${this.baseUrl}/dashboard/project-stats/${projectId}`)
      .pipe(catchError(this.handleError));
  }
  ...
  getDomainNames(): Observable<any> {
    return this.http.get("assets/domain-names.json");
  }
}
